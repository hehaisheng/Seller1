...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initData() {
        ...
        shopName=sharedPreferences.getString("ShopName","0");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.login_clickText:
                ...
                if(accountString1.equals(account)&&passwordString1.equals(password)&&nameString1.equals(shopName)){
                    ...
                    if(!hasAccount){
                        ...
                        Toast.makeText(this,"重新输入账号,密码,商户名",Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.register_clickText:
                ...
                if(nameString.length()<1){
                    Toast.makeText(this,"商户名长度应该大于1",Toast.LENGTH_SHORT).show();
                    break;
                }
